    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <Link
          ...
          className="bg-gradient-to-br from-indigo-500 to-indigo-600 text-white rounded-xl p-6 hover:from-indigo-600 hover:to-indigo-700 transition-all shadow-lg"
        >
          <div className="flex items-center justify-between">
            <div>
        ...
        <Link
          ...
          className="bg-gradient-to-br from-emerald-500 to-emerald-600 text-white rounded-xl p-6 hover:from-emerald-600 hover:to-emerald-700 transition-all shadow-lg"
        >
          <div className="flex items-center justify-between">
            <div>
        ...
        <Link
          ...
          className="bg-gradient-to-br from-amber-500 to-amber-600 text-white rounded-xl p-6 hover:from-amber-600 hover:to-amber-700 transition-all shadow-lg"
        >
          <div className="flex items-center justify-between">
            <div>
