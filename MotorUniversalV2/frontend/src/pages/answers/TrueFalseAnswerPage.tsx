  ...
  return (
    <div className="max-w-3xl mx-auto fluid-p-6">
      ...
      <div className="mb-6">
        ...
        <h1 className="fluid-text-2xl font-bold text-gray-900 fluid-mb-2">Configurar Respuesta Verdadero/Falso</h1>
        <p className="text-gray-600 fluid-text-base">Selecciona la respuesta correcta para esta pregunta</p>
      </div>
