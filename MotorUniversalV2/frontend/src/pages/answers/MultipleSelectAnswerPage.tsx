        ...
        <div className="card fluid-mb-6">
          <div className="fluid-mb-6">
            <div className="flex flex-col sm:flex-row justify-between items-start fluid-gap-3 fluid-mb-3">
              <div>
                <h3 className="fluid-text-xl font-semibold text-gray-900 fluid-mb-2">Opciones de Respuesta</h3>
          ...
          <div className="flex flex-col fluid-gap-4">
            {answers.map((answer, index) => (
              <div
                key={index}
                className={`border rounded-lg fluid-p-4 transition-all ${
                  answer.is_correct
              ...
              >
                <div className="flex items-start fluid-gap-3">
                  ...
                  {/* Letra de la opción */}
                  <div className="flex-shrink-0 w-8 h-8 rounded-full bg-primary-100 text-primary-700 font-semibold flex items-center justify-center fluid-text-sm">
                  ...
                  <input
                    ...
                    className={`flex-1 fluid-px-4 fluid-py-2 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200 fluid-text-sm ${
                ...
                {answer.is_correct && (
                  <div className="fluid-mt-2 ml-10 flex items-center fluid-text-sm text-green-700">
