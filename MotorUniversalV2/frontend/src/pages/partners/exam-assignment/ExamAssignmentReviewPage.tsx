...
import {
  ...
  AlreadyAssignedCandidate, NewAssignmentDetail,
...
export default function ExamAssignmentReviewPage() {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      // Show modal with assignment results
      setModalNewAssignments(result.new_assignments || []);
      setModalAlreadyAssigned(result.already_assigned || []);
      setShowSuccessModal(true);
      setSaving(false);
    } catch (err: any) {
