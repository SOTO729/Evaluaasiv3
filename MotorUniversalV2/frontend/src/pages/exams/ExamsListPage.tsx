...
const ExamCard = ({ 
  ...
  return (
    <div 
      className="bg-white rounded-fluid-xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 group animate-stagger-in"
      style={{ animationDelay: `${index * 50}ms` }}
    >
      {/* Card Image - altura fluid */}
      <div 
      ...
      >
        ...
        {showStatus && !isCandidate && (
          <div className="absolute fluid-top-3 fluid-left-3">
            <span
        ...
        {/* Version Badge */}
        <div className="absolute fluid-top-3 fluid-right-3">
      ...
      <div className="fluid-p-4">
        <h3 
          className="font-semibold text-gray-900 fluid-mb-2 fluid-text-base line-clamp-1 transition-colors cursor-pointer hover:text-blue-600"
          onClick={handleCardClick}
        >
          {exam.name}
        </h3>
