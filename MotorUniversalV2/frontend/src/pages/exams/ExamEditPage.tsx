...
const ExamEditPage = () => {
  ...
  return (
    <div className="w-full max-w-[2800px] mx-auto fluid-px-6 animate-fade-in-up">
      ...
      <div
        onClick={() => navigate(`/exams/${id}/config`)}
        className="bg-white rounded-fluid-2xl shadow-sm border border-gray-200 fluid-p-6 fluid-mb-6 hover:shadow-lg hover:border-blue-200 transition-all duration-300 cursor-pointer group"
      >
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center fluid-gap-4">
            ...
            <div className="hidden md:flex items-center fluid-gap-3">
              <span className="fluid-px-3 fluid-py-1 bg-gray-100 rounded-fluid-lg fluid-text-sm font-medium text-gray-700">
                {exam.default_max_attempts ?? 2} reintentos
              </span>
              <span className="fluid-px-3 fluid-py-1 bg-gray-100 rounded-fluid-lg fluid-text-sm font-medium text-gray-700">
                {exam.default_max_disconnections ?? 3} desconexiones
              </span>
              <span className="fluid-px-3 fluid-py-1 bg-gray-100 rounded-fluid-lg fluid-text-sm font-medium text-gray-700">
            ...
            <svg className="fluid-icon-base text-gray-400 group-hover:text-blue-600 group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
