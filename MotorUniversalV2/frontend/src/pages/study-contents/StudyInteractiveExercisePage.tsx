...
import {
  ...
  getActionTypeName,
  EDITOR_CONFIG,
  COMMENT_REFERENCE_WIDTH,
} from './interactive/editorHelpers'
import type {
  Tool,
  DragState,
  ResizeState,
...
import { LabelStyleDropdown, LabelStyleIcon, getLabelStyleInfo, styleHasText } from './interactive/LabelStyle'

// Modal y estilos de etiqueta: ver ./interactive/Modal y ./interactive/LabelStyle

// Helpers, tipos y constantes del editor: ver ./interactive/editorHelpers.ts
                    ...
                    {(() => {
                      const sortedActions = [...currentStep.actions]
                        .sort((a, b) => {
                          ...
                          // botones incorrectos tercero (prioridad 2)
                          // comentarios al final (prioridad 3)
                          const getPriority = (action: StudyInteractiveExerciseAction) => {
                            ...
                            if (action.action_type === 'comment') return 3;
                            return 2;
                          };
                      ...
                      // Tarjeta especial para comentarios
                      if (isComment) {
                        return (
                          <div
                            key={action.id}
                          ...
                          >
                            ...
                            <div 
                              ...
                              style={{
                                ...
                                border: `2px solid ${action.comment_text_color || '#ffffff'}40`,
                              }}
                            >
