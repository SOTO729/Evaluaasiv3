 ...
 * 
 * Formulario para solicitar saldo y/o becas de MÚLTIPLES planteles:
...
export default function SolicitarSaldoPage() {
  ...
  const [newLineType, setNewLineType] = useState<'saldo' | 'beca'>('saldo');
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-10 2xl:px-12 3xl:px-16 py-6 lg:py-8">
        <div className="max-w-[1800px] mx-auto">
          ...
          <div className="space-y-6">
            ...
            {/* Info */}
            <div className="p-4 lg:p-5 bg-primary-50 border border-primary-200 rounded-2xl flex items-start gap-3">
                                ...
                                <div className="px-4 py-4 bg-primary-50/50 border-t border-primary-100">
                                  {isLoading ? (
                                    ...
                                    <>
                                      ...
                                      {newLineUnits > 0 && (
                                        <div className="mt-3 p-3 bg-white rounded-xl border border-primary-200 text-sm">
