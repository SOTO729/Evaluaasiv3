...
class Brand(db.Model):
    """
    Modelo de Marca para estándares de competencia (ECM)
    ...
    # Auditoría
    created_by = db.Column(db.String(36), db.ForeignKey('users.id', ondelete='NO ACTION'), nullable=True, index=True)
